  ...
  const artworks = [
    {
      ...
      artist: "Andy Warhol",
      description:
        "Campbell’s Soup Cans is a series of 32 paintings, each representing a different flavor of Campbell’s canned soup, a popular American product.",
      position: [-4, 1, -3],
      rotation: [0, Math.PI / 8, 0],
      texture: "/art/img1.jpg",
    },
    {
      id: 2,
      ...
      description:
        "Composition VIII is a masterpiece of geometric abstraction, filled with a dynamic arrangement of circles, triangles, lines, and curves in an energetic yet balanced composition.",
      position: [-1.5, 1, -4],
      rotation: [0, 0, 0],
      texture: "/art/img2.jpg",
    },
    {
      id: 3,
      title: "Drip painting",
      ...
      description:
        "Jackson Pollock revolutionized modern art with his drip painting technique, where he poured, dripped, and splattered paint onto a canvas laid on the floor.",
      position: [1.5, 1, -4],
      rotation: [0, 0, 0],
      texture: "/art/img3.jpg",
    },
    {
      id: 4,
      ...
      description:
        "Persistence of Memory is one of Salvador Dalí's most famous surrealist paintings. It features a barren landscape with melting clocks draped over objects, symbolizing the fluidity and relativity of time.",
      position: [4, 1, -3],
      rotation: [0, -Math.PI / 8, 0],
      texture: "/art/img4.jpg",
    },
  ]
  ...
  return (
    <>
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -1, 0]} receiveShadow>
        ...
        <meshStandardMaterial color={isDark ? "#A8A29E" : "#A8A29E"} metalness={0.2} roughness={0.8} />
      </mesh>

      {/* Walls */}
      <mesh position={[0, 1, -5]} receiveShadow>
        <boxGeometry args={[20, 5, 0.2]} />
        <meshStandardMaterial color={isDark ? "#2C2C2C" : "#2C2C2C"} metalness={0.1} roughness={0.9} />
      </mesh>

      <mesh position={[-5, 1, 0]} rotation={[0, Math.PI / 2, 0]} receiveShadow>
        <boxGeometry args={[10, 5, 0.2]} />
        <meshStandardMaterial color={isDark ? "#E3D5C2" : "#E3D5C2"} metalness={0.1} roughness={0.9} />
      </mesh>
