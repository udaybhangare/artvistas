  ...
  const artworks = [
    {
      ...
      artist: "Pedro Ramírez Vázquez",
      description:
        "The Museo Nacional de Antropología (National Museum of Anthropology) in Mexico City is renowned for its extensive collection and striking architecture.",
      position: [-4, 1, -3],
      rotation: [0, Math.PI / 8, 0],
      texture: "/history/img1.jpg",
    },
    {
      id: 2,
      title: "Rosetta Stone",
      ...
      description:
        "A key artifact that helped decode Egyptian hieroglyphs, featuring inscriptions in Greek, Demotic, and Hieroglyphic scripts.",
      position: [-1.5, 1, -4],
      rotation: [0, 0, 0],
      texture: "/history/img2.webp",
    },
    {
      id: 3,
      title: "Teracotta Army",
      artist: "Emperor Qin Shi Huang’s Mausoleum",
      description:
        "A vast collection of life-sized clay soldiers buried with China’s first emperor to protect him in the afterlife.",
      position: [1.5, 1, -4],
      rotation: [0, 0, 0],
      texture: "/history/img3.jpg",
    },
    {
      id: 4,
      title: "The Mask of Agamemnon",
      artist: "Ancient Mycenaean craftsmen",
      description:
        "The Mask of Agamemnon is a solid gold funerary mask found in a royal tomb at Mycenae. It is one of several gold masks placed over the faces of deceased rulers.",
      position: [4, 1, -3],
      rotation: [0, -Math.PI / 8, 0],
      texture: "/history/img4.jpg",
    },
  ]
  ...
  return (
    <>
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -1, 0]} receiveShadow>
        ...
        <meshStandardMaterial color={isDark ? "#A29B94" : "#A29B94"} metalness={0.2} roughness={0.8} />
      </mesh>

      {/* Walls */}
      <mesh position={[0, 1, -5]} receiveShadow>
        <boxGeometry args={[20, 5, 0.2]} />
        <meshStandardMaterial color={isDark ? "#5A3E2B" : "#5A3E2B"} metalness={0.1} roughness={0.9} />
      </mesh>

      <mesh position={[-5, 1, 0]} rotation={[0, Math.PI / 2, 0]} receiveShadow>
        <boxGeometry args={[10, 5, 0.2]} />
        <meshStandardMaterial color={isDark ? "#D8C3A5" : "#D8C3A5"} metalness={0.1} roughness={0.9} />
      </mesh>
